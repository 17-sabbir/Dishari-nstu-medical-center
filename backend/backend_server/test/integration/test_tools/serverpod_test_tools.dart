...
import 'package:backend_server/src/generated/create_test_result_dto.dart'
    as _i32;
...
import 'package:backend_server/src/generated/qr_token_dto.dart' as _i37;
import 'package:backend_server/src/generated/qr_resolve_dto.dart' as _i38;
...
class _DoctorEndpoint {
  ...
  _i3.Future<_i30.PatientPrescriptionDetails?> getPrescriptionDetails(
    _i1.TestSessionBuilder sessionBuilder, {
    required int prescriptionId,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i30.PatientPrescriptionDetails?>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _LabEndpoint {
  ...
  _i3.Future<_i32.CreateTestResultDto?> createTestResult(
    _i1.TestSessionBuilder sessionBuilder, {
    required int testId,
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i32.CreateTestResultDto?>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i37.QrTokenDto?> generateResultQr(
    _i1.TestSessionBuilder sessionBuilder, {
    required int resultId,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'lab',
            method: 'generateResultQr',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'lab',
          methodName: 'generateResultQr',
          parameters: _i1.testObjectToJson({'resultId': resultId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
  ...
  _i3.Future<_i37.QrTokenDto?> regenerateResultQr(
    _i1.TestSessionBuilder sessionBuilder, {
    required int resultId,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'lab',
            method: 'regenerateResultQr',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'lab',
          methodName: 'regenerateResultQr',
          parameters: _i1.testObjectToJson({'resultId': resultId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
  ...
  _i3.Future<_i38.QrResolveDto?> resolveQrToken(
    _i1.TestSessionBuilder sessionBuilder, {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'lab',
            method: 'resolveQrToken',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'lab',
          methodName: 'resolveQrToken',
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i38.QrResolveDto?>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
