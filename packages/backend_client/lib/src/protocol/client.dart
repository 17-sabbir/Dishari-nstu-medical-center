...
import 'package:backend_client/src/protocol/create_test_result_dto.dart'
    as _i31;
...
import 'package:backend_client/src/protocol/qr_token_dto.dart' as _i36;
import 'package:backend_client/src/protocol/qr_resolve_dto.dart' as _i37;
...
class EndpointDoctor extends _i1.EndpointRef {
  ...
  _i2.Future<_i29.PatientPrescriptionDetails?> getPrescriptionDetails({
    required int prescriptionId,
  }) => caller.callServerEndpoint<_i29.PatientPrescriptionDetails?>(
    'doctor',
...
class EndpointLab extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i30.LabTests>> getAllLabTests() =>
      caller.callServerEndpoint<List<_i30.LabTests>>(
        'lab',
        'getAllLabTests',
        {},
      );
  ...
  _i2.Future<_i31.CreateTestResultDto?> createTestResult({
    required int testId,
    required String patientName,
    required String mobileNumber,
    required String patientType,
  }) => caller.callServerEndpoint<_i31.CreateTestResultDto?>(
    'lab',
    'createTestResult',
    {
      'testId': testId,
  ...
  _i2.Future<bool> createLabTest(_i30.LabTests test) =>
      caller.callServerEndpoint<bool>(
        'lab',
        'createLabTest',
        {'test': test},
  ...
  _i2.Future<bool> updateLabTest(_i30.LabTests test) =>
      caller.callServerEndpoint<bool>(
        'lab',
        'updateLabTest',
        {'test': test},
  ...
  _i2.Future<_i36.QrTokenDto?> generateResultQr({required int resultId}) =>
      caller.callServerEndpoint<_i36.QrTokenDto?>(
        'lab',
        'generateResultQr',
        {'resultId': resultId},
      );
  ...
  /// also lifetime-valid.
  _i2.Future<_i36.QrTokenDto?> regenerateResultQr({required int resultId}) =>
      caller.callServerEndpoint<_i36.QrTokenDto?>(
        'lab',
        'regenerateResultQr',
        {'resultId': resultId},
  ...
  _i2.Future<_i37.QrResolveDto?> resolveQrToken({required String token}) =>
      caller.callServerEndpoint<_i37.QrResolveDto?>(
        'lab',
        'resolveQrToken',
        {'token': token},
      );
...
class EndpointPatient extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i30.LabTests>> listTests() =>
      caller.callServerEndpoint<List<_i30.LabTests>>(
        'patient',
        'listTests',
        {},
